    ...
    render() {
        return (
            <div className='HeroBanner slideText'>
                ...
                <div className='title'>I am Yousuf, a novice full-stack web developer and data science enthusiast, excited to build applications that unleash the power of our data.</div>
